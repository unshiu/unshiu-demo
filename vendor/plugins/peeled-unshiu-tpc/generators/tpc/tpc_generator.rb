class TpcGenerator < Rails::Generator::NamedBase
  def initialize(runtime_args, runtime_options = {})
    ...
    if runtime_options[:version] != nil
      ...
      actual_version = Tpc::VERSION::STRING
      
      if min_version > actual_version
        raise "version error in TpcGenerator: except " + min_version + ", actual " + actual_version
      end
    end
  end
  ...
  def manifest
    record do |m| 
      prefix = 'vendor/plugins/tpc/generators/tpc/templates/'
